...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Slot', fields ['symbol', 'language']
        db.create_unique('banners_slot', ['symbol', 'language'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Slot', fields ['symbol', 'language']
        db.delete_unique('banners_slot', ['symbol', 'language'])
